package com.arturk.fullname.config;
...
public class ActiveMQConfig {
    ...
    @Bean
    public DefaultJmsListenerContainerFactory jmsProcessCustomerListenerContainerFactory() {
        DefaultJmsListenerContainerFactory factory = new DefaultJmsListenerContainerFactory();
        factory.setConnectionFactory(connectionFactory());
        factory.setClientId(properties.getClientId());
        factory.setSubscriptionDurable(true);
        factory.setPubSubDomain(true);
        factory.setDestinationResolver((session, destinationName, pubSubDomain) -> processCustomerTopic());
        return factory;
    }
